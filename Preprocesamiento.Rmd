...
oasis_cross_sectional$CDR=factor(oasis_cross_sectional$CDR,levels=c(0,0.5,1,2),
                           labels=c("Nondemented", "Demented", "Demented", "Demented"))

oasis_cross_sectional_narm=na.omit(oasis_cross_sectional)
nrow(oasis_cross_sectional_narm)
p1 <- ggplot(data = oasis_cross_sectional_narm, aes(x = Age, fill = CDR)) +
      geom_density(alpha = 0.5) +
      scale_fill_manual(values = c("gray50", "orangered2")) +
      geom_rug(aes(color = CDR), alpha = 0.5) +
      scale_color_manual(values = c("gray50", "orangered2")) +
      theme_bw()
p2 <- ggplot(data = oasis_cross_sectional_narm, aes(x = CDR, y = Age, color = CDR)) +
      geom_boxplot(outlier.shape = NA) +
      geom_jitter(alpha = 0.3, width = 0.15) +
      scale_color_manual(values = c("gray50", "orangered2")) +
      theme_bw()
...
#Calculamos la media y la mediana
tapply(oasis_cross_sectional_narm$Age, oasis_cross_sectional_narm$CDR, mean)
tapply(oasis_cross_sectional_narm$Age, oasis_cross_sectional_narm$CDR, median)
````
...
p1 <- ggplot(data = oasis_cross_sectional_narm, aes(x = eTIV, fill = CDR)) +
      geom_density(alpha = 0.5) +
      scale_fill_manual(values = c("gray50", "orangered2")) +
      geom_rug(aes(color = CDR), alpha = 0.5) +
      scale_color_manual(values = c("gray50", "orangered2")) +
      theme_bw()
p2 <- ggplot(data = oasis_cross_sectional_narm, aes(x = CDR, y = eTIV, color = CDR)) +
      geom_boxplot(outlier.shape = NA) +
      geom_jitter(alpha = 0.3, width = 0.15) +
      scale_color_manual(values = c("gray50", "orangered2")) +
      theme_bw()
...
#Calculamos la media y la mediana
tapply(oasis_cross_sectional_narm$eTIV, oasis_cross_sectional_narm$CDR, mean)
tapply(oasis_cross_sectional_narm$eTIV, oasis_cross_sectional_narm$CDR, median)
````
...
p1 <- ggplot(data = oasis_cross_sectional_narm, aes(x = nWBV, fill = CDR)) +
      geom_density(alpha = 0.5) +
      scale_fill_manual(values = c("gray50", "orangered2")) +
      geom_rug(aes(color = CDR), alpha = 0.5) +
      scale_color_manual(values = c("gray50", "orangered2")) +
      theme_bw()
p2 <- ggplot(data = oasis_cross_sectional_narm, aes(x = CDR, y = nWBV, color = CDR)) +
      geom_boxplot(outlier.shape = NA) +
      geom_jitter(alpha = 0.3, width = 0.15) +
      scale_color_manual(values = c("gray50", "orangered2")) +
      theme_bw()
...
#Calculamos la media y la mediana
tapply(oasis_cross_sectional_narm$nWBV, oasis_cross_sectional_narm$CDR, mean)
tapply(oasis_cross_sectional_narm$nWBV, oasis_cross_sectional_narm$CDR, median)
...
p1 <- ggplot(data = oasis_cross_sectional_narm, aes(x = ASF, fill = CDR)) +
      geom_density(alpha = 0.5) +
      scale_fill_manual(values = c("gray50", "orangered2")) +
      geom_rug(aes(color = CDR), alpha = 0.5) +
      scale_color_manual(values = c("gray50", "orangered2")) +
      theme_bw()
p2 <- ggplot(data = oasis_cross_sectional_narm, aes(x = CDR, y = ASF, color = CDR)) +
      geom_boxplot(outlier.shape = NA) +
      geom_jitter(alpha = 0.3, width = 0.15) +
      scale_color_manual(values = c("gray50", "orangered2")) +
      theme_bw()
...
#Calculamos la media y la mediana
tapply(oasis_cross_sectional_narm$ASF, oasis_cross_sectional_narm$CDR, mean)
tapply(oasis_cross_sectional_narm$ASF, oasis_cross_sectional_narm$CDR, median)
````
...
p1 <- ggplot(data = oasis_cross_sectional_narm, aes(x = MMSE, fill = CDR)) +
      geom_density(alpha = 0.5) +
      scale_fill_manual(values = c("gray50", "orangered2")) +
      geom_rug(aes(color = CDR), alpha = 0.5) +
      scale_color_manual(values = c("gray50", "orangered2")) +
      theme_bw()
p2 <- ggplot(data = oasis_cross_sectional_narm, aes(x = CDR, y = MMSE, color = CDR)) +
      geom_boxplot(outlier.shape = NA) +
      geom_jitter(alpha = 0.3, width = 0.15) +
      scale_color_manual(values = c("gray50", "orangered2")) +
      theme_bw()
...
#Calculamos la media y la mediana
tapply(oasis_cross_sectional_narm$MMSE, oasis_cross_sectional_narm$CDR, mean)
tapply(oasis_cross_sectional_narm$MMSE, oasis_cross_sectional_narm$CDR, median)
````
...
oasis_cross_sectional_narm$EDUC=oasis_cross_sectional_narm$Educ
p1 <- ggplot(data = oasis_cross_sectional_narm, aes(x = EDUC, fill = CDR)) +
      geom_density(alpha = 0.5) +
      scale_fill_manual(values = c("gray50", "orangered2")) +
      geom_rug(aes(color = CDR), alpha = 0.5) +
      scale_color_manual(values = c("gray50", "orangered2")) +
      theme_bw()
p2 <- ggplot(data = oasis_cross_sectional_narm, aes(x = CDR, y = EDUC, color = CDR)) +
      geom_boxplot(outlier.shape = NA) +
      geom_jitter(alpha = 0.3, width = 0.15) +
      scale_color_manual(values = c("gray50", "orangered2")) +
      theme_bw()
...
#Calculamos la media y la mediana
tapply(oasis_cross_sectional_narm$EDUC, oasis_cross_sectional_narm$CDR, mean)
tapply(oasis_cross_sectional_narm$EDUC, oasis_cross_sectional_narm$CDR, median)
````
...
#Status socioeconómico
ggplot(data = oasis_cross_sectional_narm, aes(x = oasis_cross_sectional_narm$SES, y = ..count.., fill = CDR)) +
  geom_bar() +
  labs(title = "SES") +
  scale_fill_manual(values = c("gray50", "orangered2")) +
  theme_bw() +
...
round(prop.table(table(oasis_cross_sectional_narm$SES, oasis_cross_sectional_narm$CDR)),2)

#Sexo
oasis_cross_sectional_narm$`M/F`=oasis_cross_sectional_narm$M.F
ggplot(data = oasis_cross_sectional_narm, aes(x = oasis_cross_sectional_narm$`M/F`, y = ..count.., fill = CDR)) +
  geom_bar() +
  labs(title = "Sex") +
  scale_fill_manual(values = c("gray50", "orangered2", "lightblue")) +
  theme_bw() +
...
round(prop.table(table(oasis_cross_sectional_narm$`M/F`, oasis_cross_sectional_narm$CDR)),2)

````

En este caso en los datos longitudinales parece haber diferencias en la variable sex pero no en la SES, mientras que en los seccionales parece haber diferencias en ambas. 
...
oasis_cross_sectional_narm$Group=oasis_cross_sectional_narm$CDR
